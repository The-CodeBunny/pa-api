...
class ContentRating implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'audienceRating' => '\TheCodeBunny\PaApi\Core\SingleStringValuedAttribute'
    ];
     ...
     * Sets audienceRating
     *
     * @param \TheCodeBunny\PaApi\Core\SingleStringValuedAttribute $audienceRating audienceRating
     *
     * @return $this
     */
