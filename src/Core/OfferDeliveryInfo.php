...
class OfferDeliveryInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'shippingCharges' => '\TheCodeBunny\PaApi\Core\OfferShippingCharge[]'
    ];
     ...
     *
     * @return \TheCodeBunny\PaApi\Core\OfferShippingCharge[]
     */
     ...
     *
     * @param \TheCodeBunny\PaApi\Core\OfferShippingCharge[] $shippingCharges shippingCharges
     *
     * @return $this
     */
