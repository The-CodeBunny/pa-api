...
class Languages implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'displayValues' => '\TheCodeBunny\PaApi\Core\LanguageType[]',
        'label' => 'string',
        'locale' => 'string'
    ];
     ...
     * Gets displayValues
     *
     * @return \TheCodeBunny\PaApi\Core\LanguageType[]
     */
     ...
     * Sets displayValues
     *
     * @param \TheCodeBunny\PaApi\Core\LanguageType[] $displayValues displayValues
     *
     * @return $this
     */
