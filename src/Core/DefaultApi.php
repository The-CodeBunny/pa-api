...
class DefaultApi
{
    ...
    {
        $returnType = '\TheCodeBunny\PaApi\Core\GetBrowseNodesResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                default:
                    $data = ObjectSerializer::deserialize(
                        $responseBody,
                        '\TheCodeBunny\PaApi\Core\ProductAdvertisingAPIServiceException',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\TheCodeBunny\PaApi\Core\GetItemsResponse';
    ...
    {
        $returnType = '\TheCodeBunny\PaApi\Core\GetVariationsResponse';
    ...
    {
        $returnType = '\TheCodeBunny\PaApi\Core\SearchItemsResponse';
